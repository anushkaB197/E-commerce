...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity<String> createNewCustomer(@RequestBody @Valid CustomerRequest request) {
        String newCustomerId = customerService.createCustomer(request);
        return ResponseEntity.ok(newCustomerId);
    }

    @PutMapping
    public ResponseEntity<Void> updateExistingCustomer(@RequestBody @Valid CustomerRequest request) {
    ...
    public ResponseEntity<Boolean> checkCustomerExists(@PathVariable("customerId") String customerId) {
